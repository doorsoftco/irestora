                     ...
                     <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="waste_quantity" readonly name="food_menu_waste_qty" class="form-control" placeholder="Waste Quantity" value="<?php echo $waste_details->food_menu_waste_qty; ?>" >
                            </div>
