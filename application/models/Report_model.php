...
class Report_model extends CI_Model {
    ...
    public function todaySummaryReport($selectedDate) {
        ...
        $balance =($result['total_sales_amount'] - ($result['total_purchase_amount']+$result['supplier_payment_amount']+$result['expense_amount']));
...
(select SUM(consumption) from tbl_sale_consumptions_detail where ingredient_id=i.ingredient_id AND outlet_id=$outlet_id AND  del_status='Live') total_consumption,
